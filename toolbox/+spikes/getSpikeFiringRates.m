function result = getSpikeFiringRates(data, params)
...
[spike_times, spike_chans] = params.OP.detectionFcn(data, ...
    'estimationFcn', params.OP.estimationFcn, ...
...
firing_rate = binned_spikes(:, params.NP.chans+1) / params.OP.bin_size;
if params.OP.smooth.apply
    firing_rate = conv2(firing_rate, params.OP.smooth.gk, "same");
end
result = {data, spike_times, spike_chans, firing_rate, params, 'getSpikeFiringRates'};