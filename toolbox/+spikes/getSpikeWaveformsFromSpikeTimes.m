function spike_waveforms = getSpikeWaveformsFromSpikeTimes(data, spike_times, spike_chans, params)
%GETSPIKEWAVEFORMSFROMSPIKETIMES Same as getSpikeWaveforms but uses
%pre-detected spikes times/chans. And returns each output as a variable,
%not combined into a cell array, average waveforms not computed.
% NOT FOR REAL-TIME USE (probably)
...
%% results
%result = {spike_waveforms, wv_avg, wv_std, params, 'getSpikeWaveforms'};
end