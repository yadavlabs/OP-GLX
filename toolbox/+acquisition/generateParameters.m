...
params.NP.chans =  0:383;%[0:2:383, 1:2:383];
...
params.OP.estimation_method = "MAD_zero_median";
params.OP.estimationFcn = params.OP.estimation_methods.(params.OP.estimation_method);
